...
\begin{figure}[t]
	...
	\end{center}
\protect\caption{
The spiral wavelet is a product of wavelets along time $t$, log-frequency $\log \lambda_1$ (angular variable), and octave index $j_1$ (radial variable).Blue and green oscillations represent the real and imaginary parts. The red envelope represents the complex modulus. Partials of an hypothetical harmonic sound are marked as thick dots.
