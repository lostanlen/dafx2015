...
\end{figure}
In the example of a trombone signal, glissando can be modeled by $\ddot{\theta} / \dot{\theta}(t)$ in the source-filter model, whereas the brassiness profile induces a timbral velocity $\ddot{\eta}(t) / \dot{\eta}(t)$. Figure 3 illustrates that these two velocities are stably disentangled and characterized.
